...
class ViewResponseLandsCape extends StatefulWidget {
  final bool reload;

  const ViewResponseLandsCape({Key key, this.reload}) : super(key: key);

  @override
  _ViewResponseLandsCapeState createState() => _ViewResponseLandsCapeState();
}

class _ViewResponseLandsCapeState extends State<ViewResponseLandsCape> {
